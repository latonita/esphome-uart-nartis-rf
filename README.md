...
Предполагается использование в комплекте с [СПОДЭС/DLMS/COSEM](https://github.com/latonita/esphome-dlms-cosem)

Назначение: счётчики электроэнергии Nartis I100/I300 (протокол "RF-433-2" /
Д101-2) через трансивер CMT2300A на ESP32.

Частота канала выбирается автоматически по серийному номеру счётчика — ничего
